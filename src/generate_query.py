...
slot_dict = {
    ...
    "Entity": ["美女", "女人", "女生"],
    "IsWho": ["是谁", "是哪个", "是哪位", "是哪个人", "是什么人"],
    "Who": ["谁", "哪些人"],
    "WhoIs": ["谁是", "哪位是", "哪个是", "哪个人是"],
    ...
    "Why-Begin": ["为什么"],
    "Why-End": ["的原因", "的原因是", "有什么原因", "的关键", "的关键原因"],
    "Pre-adj": ["有史以来", "历史上"],
    "adj": ["最美丽的", "最漂亮的", "最有魅力的", "最好看的"],
    # "Result": ["成功", "能成功", "成功实施", "得以成功实施"]
    "Result": ["灭绝", "消失"]
}
template_list = [
    "[WhoIs][Pre-adj][adj][Entity]",
    "[Pre-adj][adj][Entity][IsWho]"
]
